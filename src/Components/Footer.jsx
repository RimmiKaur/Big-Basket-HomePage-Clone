    ...
    return (
        <>
            <div className='w-[1170px] mx-auto'>
                <h3 className='font-bold'>bigbasket – online grocery store</h3>
            ...
            <div className=' bg-[#101010] mt-5 text-white'>
                <div className='mx-auto w-[1170px] flex justify-between'>
                    <div className='p-5 m-4 leading-[35px] mt-[50px]' >
                        Bigbasket
                        <br />
                        About Us
                        <br />
                        Become A bigbasket Rider<br />
                        In News<br />
                        Green bigbasket<br />
                        Privacy Policy<br />
                        Terms and Conditions<br />
                        Careers At bigbasket<br />
                        bb Instant
                        <br />
                        bb Daily
                        <br />
                    ...
                    <img className="w-[280px] h-[200px] mt-[50px]" src="\src\assets\Images\socials.png" />

                </div>

                <div className='text-center w-[1170px] mx-auto pt-5'>
                    <p>
                ...
                <hr className='mb-5 border-dashed mt-5'/>


                <div className='flex mx-auto w-[1170px] justify-between leading-7 text-[12px] pb-5 '>
                    <div>
                        <p>
                ...
                <div className=' bg-black py-1'>
                    <p className='mx-auto w-[1170px] text-[14px]'>
